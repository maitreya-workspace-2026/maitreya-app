...
export const ShieldCheckIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 20.944a11.955 11.955 0 0118 0a12.02 12.02 0 00-2.382-9.016z" />
  </svg>
);
...
export const PillIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0h18M12 12.75h.008v.008H12v-.008zm0 4.5h.008v.008H12v-.008zm4.5-4.5h.008v.008H16.5v-.008zm0 4.5h.008v.008H16.5v-.008zM12 12.75a.375.375 0 11-1.5 0 .375.375 0 011.5 0z" />
  </svg>
);

export const UtensilsIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M12.75 3.375v17.25M8.25 3.375v17.25M3 3.375h18M3 20.625h18" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M11.25 3.375c0 4.305-1.077 8.16-2.887 11.026M12.75 3.375c0 4.305 1.077 8.16 2.887 11.026" />
  </svg>
);
...
export const WaterDropIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21.75c-4.286 0-7.75-3.464-7.75-7.75 0-4.286 7.75-12.25 7.75-12.25s7.75 7.964 7.75 12.25c0 4.286-3.464 7.75-7.75 7.75z" />
    </svg>
);
...
// Added BriefcaseIcon to fix import errors in Dashboard and ConversationContainer
